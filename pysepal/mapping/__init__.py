...
The main object is the ``SepalMap``that should be used in favor of ``Map`` in **pysepal** framework. The others are predisgned controls that can be helpful to speed up developments.
