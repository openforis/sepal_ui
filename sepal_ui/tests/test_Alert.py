...
class TestAlert(unittest.TestCase):
    ...
    def test_add_msg(self):
        ...
        self.assertEqual(alert.children[0], msg, 'the message is not diplayed')
    ...
    def test_bind(self):
        ...
        self.assertEqual(alert.children[0], 'The selected variable is: {}'.format(msg), 'the variable is not diplayed')
        self.assertEqual(alert2.children[0], 'new variable : {}'.format(msg), 'display does not use custom msg')
    ...
    def test_check_input(self): 
        ...
        self.assertEqual(alert.children[0], "The value has not been initialized")
        
        res = alert.check_input(var_test, 'toto')
        self.assertEqual(alert.children[0], 'toto')
