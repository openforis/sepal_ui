...
from sepal_ui.mapping.basemaps import BASEMAP_DARK, BASEMAP_LIGHT, basemap_tiles
...
class SepalMap(ipl.Map):
    ...
    def _on_theme_change(self, _) -> None:
        ...
        for layer in self.layers:
            if layer.base and layer.url in [BASEMAP_LIGHT, BASEMAP_DARK]:
                layer.url = BASEMAP_DARK if v.theme.dark is True else BASEMAP_LIGHT
